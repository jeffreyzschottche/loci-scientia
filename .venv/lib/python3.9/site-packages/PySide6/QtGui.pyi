...
class QFont(Shiboken.Object):
    ...
    @overload
    def setFeature(self, feature: Union[bytes, bytearray, memoryview], value: int) -> None: ...
    @overload
    ...
    @staticmethod
    def stringToTag(tagString: Union[bytes, bytearray, memoryview]) -> int: ...
    ...
    @overload
    def unsetFeature(self, feature: Union[bytes, bytearray, memoryview]) -> None: ...
    @overload
...
class QImage(PySide6.QtGui.QPaintDevice):
    ...
    @overload
    def __init__(self, fileName: Union[str, bytes, os.PathLike], format: Union[bytes, bytearray, memoryview, NoneType] = ...) -> None: ...
    @overload
...
class QPixmap(PySide6.QtGui.QPaintDevice):
    ...
    def __init__(self, arg__1: Union[PySide6.QtGui.QPixmap, PySide6.QtGui.QImage, str]) -> None: ...
    @overload
    def __init__(self, fileName: Union[str, bytes, os.PathLike], format: Union[bytes, bytearray, memoryview, NoneType] = ..., flags: PySide6.QtCore.Qt.ImageConversionFlag = ...) -> None: ...
    @overload
    def __init__(self, image: Union[PySide6.QtGui.QImage, str]) -> None: ...
    @overload
    def __init__(self, w: int, h: int) -> None: ...
...
class QRhiMetalInitParams(PySide6.QtGui.QRhiInitParams):

    @overload
    def __init__(self) -> None: ...
    @overload
    def __init__(self, QRhiMetalInitParams: PySide6.QtGui.QRhiMetalInitParams) -> None: ...
